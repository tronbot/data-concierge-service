...
public class CacheConfiguration {
	...
	public CacheConfiguration(Environment env, DiscoveryClient discoveryClient, Registration registration,
	...
	public HazelcastInstance hazelcastInstance() {
		...
		// In development, everything goes through 127.0.0.1, with a different
		// port
		if (env.acceptsProfiles(Constants.SPRING_PROFILE_DEVELOPMENT)) {
			...
			// Prod config, one host per instance all using port 5701
